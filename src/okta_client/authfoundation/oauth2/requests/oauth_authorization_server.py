...
@dataclass
class OAuthAuthorizationServerRequest(JSONRequest):
    """Request for OAuth Authorization Server configuration."""
    ...
    def url(self) -> str:
        ...
        return urljoin(self.issuer.rstrip("/") + "/", ".well-known/oauth-authorization-server")
