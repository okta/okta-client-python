...
After cloning the repository, install all dependencies (including dev tools) with:

``` bash
$ make deps
```

This installs the package in editable mode along with test, lint, and build tools.

### Code Style

This project uses [Ruff](https://docs.astral.sh/ruff/) for linting and formatting. Before submitting a PR, ensure your changes pass lint:

``` bash
$ make lint
```

To auto-fix common lint issues:
...
Please ensure **all tests pass** and **lint is clean** before submitting your PR.


Fork the code
-------------

In your browser, navigate to: [https://github.com/okta/okta-client-python](https://github.com/okta/okta-client-python)

Fork the repository by clicking on the 'Fork' button on the top right hand side.  The fork will happen and you will be taken to your own fork of the repository.  Copy the Git repository URL by clicking on the clipboard next to the URL on the right hand side of the page under '**HTTPS** clone URL'.  You will paste this URL when doing the following `git clone` command.

On your computer, follow these steps to setup a local repository for working on the Okta Client SDK:

``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-client-python.git
$ cd okta-client-python
$ git remote add upstream https://github.com/okta/okta-client-python.git
$ git checkout main
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-client-python](https://github.com/YOUR_ACCOUNT/okta-client-python)
